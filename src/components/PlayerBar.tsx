...
export const PlayerBar: React.FC<PlayerBarProps> = React.memo(({
  ...
  return (
    <div className="fixed bottom-14 md:bottom-3 left-1/2 -translate-x-1/2 w-[98%] sm:w-[95%] max-w-5xl z-30 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-2xl shadow-xl dark:shadow-2xl shrink-0 select-none transition-all duration-300 overflow-hidden">
      ...
      {isPodcast && (
        <div className="bg-amber-500/10 dark:bg-amber-500/5 border-b border-zinc-200 dark:border-zinc-800/80 px-3 sm:px-5 py-2 space-y-1.5">
          <div className="flex items-center justify-between text-xs">
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              ...
              <button
                ...
                className="px-2 py-0.5 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-amber-500 hover:text-zinc-950 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700 text-[11px] font-bold transition-all active:scale-95"
                title="Oynatma Hızı"
              >
                {playbackRate}x Hız
              </button>
              ...
              <button
                ...
                className="px-2 py-0.5 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-amber-500 hover:text-zinc-950 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700 text-[11px] font-bold flex items-center space-x-1 transition-all active:scale-95"
                title="10 saniye geri sar"
              >
                <RotateCcw className="w-3 h-3 text-amber-500" />
                <span className="hidden sm:inline">10s Geri</span>
              </button>
              ...
              >
                ...
                <span className="hidden sm:inline">30s İleri</span>
              </button>
            </div>
          </div>
          ...
          <div className="relative w-full group cursor-pointer py-1.5 flex items-center">
            ...
            <div
              className="absolute w-4 h-4 sm:w-5 sm:h-5 bg-amber-400 border-2 border-zinc-950 rounded-full shadow-lg pointer-events-none transform -translate-x-1/2 transition-transform group-hover:scale-125 z-20"
