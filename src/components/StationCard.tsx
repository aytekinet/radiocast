...
export const StationCard: React.FC<StationCardProps> = React.memo(({
  ...
  return (
    <div
      ...
      className={`group relative rounded-2xl p-3.5 border transition-all duration-200 ease-out flex flex-col justify-between cursor-pointer h-[136px] min-h-[136px] max-h-[136px] overflow-hidden ${
        isCurrentStation
    ...
    >
      ...
      <div className="flex-1 min-h-0 flex flex-col justify-between">
        <div className="flex items-start justify-between gap-2 mb-1.5">
          ...
          <div className="relative shrink-0">
            {station.favicon && !imgError ? (
              ...
              <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700/80 flex items-center justify-center text-amber-500">
        ...
        {/* Station Title & Info */}
        <h3 className="font-bold text-xs text-zinc-900 dark:text-zinc-100 group-hover:text-amber-500 transition-colors line-clamp-1 mb-1.5">
          {station.name}
        </h3>
